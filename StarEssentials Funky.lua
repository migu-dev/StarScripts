...
local DiscordLib = loadstring(game:HttpGet"https://starwhitelist.000webhostapp.com/Scripts/fdssfdfsxaLibfsdafasd")()

local win = DiscordLib:Window("StarEssentials")
...
DiscordLib:Notification("StarEssentials", "Set score to Infinite", "Okay!")
local args = {
    [1] = {
        [1] = "Server",
        [2] = "SongManager",
